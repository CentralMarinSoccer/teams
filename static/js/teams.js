...
var Teams = (function () {
    ...
    var Game = (function (dateObj, teamName) {
        ...
        return {
            compareString: function () {
                return _dateObj + _teamName;
            },
            display: function () {
                return _dateObj.displayTime() + ": " + _teamName;
            },
    ...
    var initMap = function () {
        ...
        _map = new google.maps.Map(document.getElementById('teams-map'));
        _datePicker = document.getElementById('teams-map-date-picker');
    ...
    var processTeams = function (data) {
        ...
        _teams.sort(function (team1, team2) {
            ...
            // Custom Sorting for CM
            if (team1.level == 'Black') return 1;
            if (team2.level == 'Black') return -1;
        ...
        years.forEach(function (year) {
            for (var i = 0; i < year.boys.length || i < year.girls.length; i++) {
                var year2 = {};
                year2.even_row = index % 2;
                if (i == 0) {
                    year2.name = year.name;
                } else {
                    year2.name = "";
                }

                if (i < year.boys.length) year2.boys = year.boys[i];
                if (i < year.girls.length) year2.girls = year.girls[i];
